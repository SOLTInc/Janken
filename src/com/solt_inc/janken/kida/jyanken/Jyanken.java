...
public class Jyanken {
	...
	public void plsyJyanken() {
		...
		Util utl = new Util();
		JyankenUtil jutl = new JyankenUtil();
		...
		while (continueflg) {
			...
			if ((hand == 1 && com == 2) || (hand == 2 && com == 3)
					|| (hand == 3 && com == 1)) {

				System.out.println("あなた:" + jutl.exchangejyanken(hand)
						+ "    COM:" + jutl.exchangejyanken(com));
				System.out.println("あなたの勝ち   スロット用コイン1枚獲得");
				System.out.println("");
				Bean.setjWin();
				Bean.coinPlus(1);

			} else if ((hand == 1 && com == 3) || (hand == 2 && com == 1)
					|| (hand == 3 && com == 2)) {
				System.out.println("あなた:" + jutl.exchangejyanken(hand)
						+ "    COM:" + jutl.exchangejyanken(com));
	...
	private void record() {
		...
		System.out.println("|勝ち   | "
				+ String.format("%6s", getKonkai(Bean.getjWin(), "jWin"))
				+ " | " + String.format("%6s", Bean.getjWin()) + " |  ");
		System.out.println("-----------------------------");
		System.out.println("|負け   | "
				+ String.format("%6s", getKonkai(Bean.getjLose(), "jLose"))
				+ " | " + String.format("%6s", Bean.getjLose()) + " |  ");
		System.out.println("-----------------------------");
		System.out.println("|あいこ | "
				+ String.format("%6s", getKonkai(Bean.getjDraw(), "jDraw"))
				+ " | " + String.format("%6s", Bean.getjDraw()) + " |  ");
		System.out.println("-----------------------------");
	}
